...
<body>
    <center>
        ...
        $sql = "INSERT INTO diplomaenroll  VALUES ('$AdmissionType','$ChoiceCode','$InstituteCode','$Region','$CourseCode','$CourseType','$CourseYear',
        ...
        '$currentadd','$dteid','$higheredu','$entranceexam','$entrancemarks','$sscboard','$sscyear','$sscmark','$scimark','$engmarks','$mathmarks','$techsub1','$techsub2','$techsub3',
       '$candtype','$income','$scholar','$typescholar','$handicap','$linguistic','$northedu','$jammukash','$projectaffect','$exserviceman','$statelevelplayer',
